                    ...
                    {success ? (
                        <div className="text-center space-y-4">
                            ...
                            <button
                                ...
                                className="w-full px-6 py-3 bg-gray-200 dark:bg-neutral-800 text-gray-900 dark:text-white rounded-xl font-semibold hover:bg-gray-300 dark:hover:bg-neutral-700 transition-colors"
                            >
                                Back to Login
                            </button>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <button
                                type="button"
                                onClick={() => navigate('/login')}
                                className="w-full px-6 py-3 flex items-center justify-center gap-2 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors"
                            >
