                ...
                {activeTab === 'dashboard' && (
                    <>
                        ...
                        <div className="relative overflow-hidden bg-neutral-900 border border-neutral-800 rounded-3xl p-8 mb-8 group">
                            <div className="absolute top-0 right-0 w-64 h-64 bg-yellow-900/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 pointer-events-none group-hover:bg-yellow-900/20 transition-all duration-700"></div>

                            <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                                <div>
                                    <div className="flex items-center gap-2 text-yellow-400 font-bold text-sm mb-2 uppercase tracking-wide">
                                ...
                                <button
                                    ...
                                    className="bg-yellow-500 hover:bg-yellow-400 text-black px-8 py-4 rounded-xl font-bold shadow-lg shadow-yellow-900/20 hover:shadow-yellow-900/40 hover:scale-105 transition-all flex items-center gap-2"
                                >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-12">
                            ...
                            <div className="bg-neutral-900 border border-neutral-800 p-5 rounded-2xl flex items-center gap-4 hover:border-neutral-700 transition-colors">
                                <div className="w-12 h-12 rounded-xl bg-neutral-800 flex items-center justify-center text-yellow-400">
                            ...
                            {loading ? (
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                    {chapters.map((chapter) => (
                                        <div
                                            key={chapter._id}
                                            className="group bg-neutral-900 border border-neutral-800 rounded-2xl p-6 hover:border-yellow-500/50 hover:shadow-2xl hover:shadow-yellow-900/10 transition-all cursor-pointer relative overflow-hidden"
                                        ...
                                        >
                                            ...
                                            <div className="relative z-10">
                                                <div className="w-12 h-12 bg-neutral-800 rounded-xl flex items-center justify-center text-yellow-400 mb-4 group-hover:bg-yellow-500 group-hover:text-black transition-colors">
                                                ...
                                                <div className="mb-6">
                                                    ...
                                                    <div className="w-full bg-neutral-800 rounded-full h-1.5 overflow-hidden">
                                                        <div className="bg-yellow-500 w-0 h-full rounded-full group-hover:w-2 transition-all duration-1000"></div>
                                                    </div>
                                                </div>

                                                <div className="mt-6 flex items-center text-sm font-medium text-yellow-400 group-hover:translate-x-2 transition-transform duration-300">
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-6">
                                ...
                                <button onClick={() => setActiveTab('library')} className="text-sm text-yellow-400 hover:text-yellow-300 font-medium flex items-center gap-1">
                            ...
                            {recentMaterials.length > 0 ? (
                                <div className="flex gap-4 overflow-x-auto pb-4 scrollbar-thin scrollbar-thumb-neutral-800 scrollbar-track-transparent">
                                    {recentMaterials.map((mat) => (
                                        <div key={mat._id} className="min-w-[240px] bg-neutral-900 border border-neutral-800 p-4 rounded-xl hover:border-yellow-500/30 transition-all group cursor-pointer">
                                            <div className="w-10 h-10 bg-neutral-800 rounded-lg flex items-center justify-center text-neutral-400 mb-3 group-hover:bg-yellow-900/20 group-hover:text-yellow-400 transition-colors">
                                            ...
                                            <a
                                                ...
                                                target="_blank"
                                                rel="noreferrer"
                                                className="text-xs font-bold text-yellow-400 group-hover:underline"
                                            >
                                                Read PDF
                                            </a>
                                        </div>
